...
Die Wahl fiel auf OSC, da es sowohl für *p5js*, als auch für *Node.js* und *Max* einfach zu nutzende Implementierungen dieses Standards gibt. Für das Versenden der *OSC* Nachrichten wird meist UDP verwendet.
